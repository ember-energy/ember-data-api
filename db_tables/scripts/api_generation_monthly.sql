...
WHERE
    generation_date >= '2000-01-01'
    AND (generation_date BETWEEN '2000-01-01' AND latest_actual_month.max_monthly_actual_generation_date)
    AND NOT (generation.country_or_region = 'World' AND generation_date >= '2025-06-01') 
